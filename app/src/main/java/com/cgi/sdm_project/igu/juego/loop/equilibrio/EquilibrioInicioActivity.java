...
public class EquilibrioInicioActivity extends Loop implements InicioJuego {
    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_equilibrio_inicio);

        ((TextView) findViewById(R.id.txtJugador)).setText(Juego.getInstance().getJugadorActual().toString());
    }

    public void jugar(View view) {
        Intent intent = new Intent(this, EquilibrioActivity.class);
